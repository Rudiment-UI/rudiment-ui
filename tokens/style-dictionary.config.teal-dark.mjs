...
export default {
  source: [
    ...
    'tokens/themes/teal-dark/tokens.json',
    'tokens/themes/teal-dark/semantic.json',
    'tokens/components.json',
    'tokens/themes/teal-dark/components.json',
  ],
  platforms: {
    css: {
      transformGroup: 'css',
      ...
      files: [
        {
          destination: 'tokens-teal-dark.css',
          format: 'css/variables',
          options: {
            selector: '[data-theme="teal-dark"]',
          ...
          filter: (token) => {
            ...
            // Include component and typography tokens so they re-resolve in teal-dark scope
            return true
          },
        },
      ],
