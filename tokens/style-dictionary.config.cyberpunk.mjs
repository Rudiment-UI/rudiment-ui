...
export default {
  source: [
    ...
    'tokens/themes/cyberpunk/semantic.json',
    'tokens/components.json',
    'tokens/themes/cyberpunk/components.json',
  ],
  platforms: {
    css: {
      transformGroup: 'css',
      ...
      files: [
        {
          destination: 'tokens-cyberpunk.css',
          ...
          filter: (token) => {
            ...
            // Include component and typography tokens so they re-resolve in cyberpunk scope
            return true
          },
        },
      ],
