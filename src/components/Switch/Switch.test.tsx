...
describe('Switch', () => {
  ...
  it('renders the track element', () => {
    const { container } = render(<Switch>Dark mode</Switch>)
    expect(container.querySelector('.rudiment-switch__track')).toBeInTheDocument()
  })

  it('renders the thumb element', () => {
    const { container } = render(<Switch>Dark mode</Switch>)
    expect(container.querySelector('.rudiment-switch__thumb')).toBeInTheDocument()
  })

  it('renders the label element', () => {
    const { container } = render(<Switch>Dark mode</Switch>)
    expect(container.querySelector('.rudiment-switch__label')).toBeInTheDocument()
  })
  ...
  it('merges a custom className', () => {
    const { container } = render(<Switch className="my-switch">Dark mode</Switch>)
    expect(container.firstChild).toHaveClass('rudiment-switch')
