...
<Cover minHeight="100vh">
  <Box bordered style={{ width: '22rem', margin: 'auto', padding: '1rem' }}>
    <Stack space="1.5rem">
      <Stack space="0.25rem">
...
export const SignInForm: Story = {
  ...
  render: () => (
    <Cover minHeight="100vh">
      <div className="rudiment-cover__centered" style={{ width: '100%', display: 'flex', justifyContent: 'center', padding: '1rem' }}>
        <Box bordered style={{ width: '22rem' }}>
          <Stack space="1.5rem">
            <Stack space="0.25rem">
              <Heading level={1} size={3}>Welcome back</Heading>
              <Text variant="caption">Sign in to your account to continue.</Text>
