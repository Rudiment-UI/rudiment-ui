      ...
      <Cover minHeight="80vh">
        <Center intrinsic style={{ flex: 1 }}>
          <Stack space="1.5rem" style={{ textAlign: 'center', maxWidth: '40rem' }}>
            ...
            <Text style={{ color: 'var(--token-color-text-subtle)' }}>
              Acme gives your team the tools to ship faster, collaborate better, and build with confidence — from first commit to production.
            </Text>
            <Cluster justify="center" space="0.75rem">
              <Button variant="primary" size="lg">Get started free</Button>
              <Button variant="secondary" size="lg">View demo</Button>
      ...
      <Box style={{ borderBlockStart: '1px solid var(--token-color-border-default)', paddingBlock: '4rem' }}>
        <Center>
          <Stack space="2.5rem">
            ...
            <Grid minCellWidth="16rem" space="1.5rem">
              {[
                { title: 'Instant deploys', body: 'Push to any branch and see your changes live in seconds.' },
                { title: 'Team collaboration', body: 'Comments, reviews, and approvals — all in one place.' },
                { title: 'Built-in analytics', body: 'Know what your users are doing without leaving the dashboard.' },
                { title: 'Role-based access', body: 'Grant the right permissions to the right people.' },
                { title: 'Audit logs', body: 'Every action is logged and searchable for compliance and debugging.' },
                { title: 'SSO & 2FA', body: 'Enterprise-grade security without the enterprise headache.' },
              ].map(({ title, body }) => (
