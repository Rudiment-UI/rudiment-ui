...
describe('Prose', () => {
  ...
  it('renders a <div> element by default', () => {
    const { container } = render(<Prose><p>Text</p></Prose>)
  ...
  it('applies rudiment-prose--sm for size="sm"', () => {
    const { container } = render(<Prose size="sm"><p>Text</p></Prose>)
  ...
  it('renders the element specified by the as prop', () => {
    const { container } = render(<Prose as="article"><p>Text</p></Prose>)
    expect(container.firstChild?.nodeName).toBe('ARTICLE')
  })

  it('merges a custom className', () => {
    const { container } = render(<Prose className="mt-4"><p>Text</p></Prose>)
    const el = container.firstChild as HTMLElement
  ...
  it('forwards additional HTML attributes', () => {
    render(<Prose data-testid="my-prose" id="prose-1"><p>Text</p></Prose>)
  ...
  it('forwards a ref to the rendered element', () => {
    ...
    render(<Prose ref={ref}><p>Text</p></Prose>)
